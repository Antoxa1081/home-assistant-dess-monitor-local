...
class QpigsInverterBaseModel(BaseModel):
...
class QpigsSensors(QpigsInverterBaseModel):
    # Grid
    grid_voltage: float
...
class QpiriConfigParams(QpigsInverterBaseModel):
    # Rated
...
class QpigsQpiriParser(BaseInverterParser):
    def sensors_from(
        self,
        q: QpigsSensors,
    ) -> InverterSensorData:
        ...
        return InverterSensorData(
            ...
            battery_power=q.battery_voltage * battery_current,
